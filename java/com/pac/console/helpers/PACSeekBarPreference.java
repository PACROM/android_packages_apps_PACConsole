 ...
 * This code has been modified. Portions copyright (C) 2015-2016 The PAC-ROM Project.
 *
...
public class PACSeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        ...
        mMinValue = attrs.getAttributeIntValue(APP, "minimum", 0);
        mDefaultValue = attrs.getAttributeIntValue(APP, "defaultVal", -1);
        mUnitsLeft = getAttributeStringValue(attrs, APP, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, APP, "unitsRight", "");
        try {
            String newInterval = attrs.getAttributeValue(APP, "interval");
            if(newInterval != null)
    ...
    protected View onCreateView(ViewGroup parent){
        ...
        {
            Log.e(TAG, "Error creating PAC seek bar preference", e);
        }
        return layout;
    }
    ...
    protected void updateView(View view) {
        ...
        try {
            ...
            Log.e(TAG, "Error updating PAC seek bar preference", e);
        }
    }
